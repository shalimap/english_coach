...
class ChatRoomPage extends StatefulWidget {
  static const routeName = '/chatroom-page';
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text(
              'മറ്റുള്ളവരുമായി  ലൈവായി ഇംഗ്ലീഷിൽ സംസാരിക്കുന്നതിനുള്ള ഓഡിയോ ചാറ്റ് റൂമo വൈകിട്ടു 4 മണി മുതൽ 9 മണി വരെ മാത്രമേ ലബ്യം ആക്കുക.',
              style: TextStyle(
                fontSize: 14,
              ),
            ...
            actions: <Widget>[
              TextButton(
                  onPressed: () {
                    ...
                    if (currentTime.hour >= 16 && currentTime.hour <= 21) {
                      print('Audio Chat Available');
                      Navigator.of(context).pop();
                      Navigator.of(context).pushReplacementNamed(
                          GroupChatRoomPage.routeName,
                          arguments: {"name": name, "userid": userId});
                    } else {
                      Navigator.of(context).pop();
                      _showDialogGroup(context);
                      print('Audio Chat Unavailable');
                    }
                  },
